...
// TODO@mason.zou vi dev structure refine
enum ISP_BLC_ID {
	ISP_BLC_ID_FE0_LE = 0,
	ISP_BLC_ID_FE0_SE,
	ISP_BLC_ID_FE1_LE,
...
static CVI_S32 isp_blc_ctrl_postprocess(VI_PIPE ViPipe)
{
	...
	switch (ViPipe) {
	case 0:
		inst_base = ISP_BLC_ID_FE0_LE;
		pre_fe_num = 2;
		pre_be_num = 2;
	break;
	case 1:
		inst_base = ISP_BLC_ID_FE1_LE;
		pre_fe_num = 2;
		pre_be_num = 2;
	break;
	case 2:
		inst_base = ISP_BLC_ID_FE2_LE;
		pre_fe_num = 2;
		pre_be_num = 2;
	break;
	case 3:
		inst_base = ISP_BLC_ID_FE3_LE;
		pre_fe_num = 2;
		pre_be_num = 2;
	break;
	case 4:
		inst_base = ISP_BLC_ID_FE4_LE;
		pre_fe_num = 2;
		pre_be_num = 2;
	break;
	case 5:
		inst_base = ISP_BLC_ID_FE5_LE;
		pre_fe_num = 2;
		pre_be_num = 2;
	break;
	default:
