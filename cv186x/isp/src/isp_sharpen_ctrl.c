...
static CVI_S32 isp_sharpen_ctrl_postprocess(VI_PIPE ViPipe)
{
	...
	if (is_postprocess_update == CVI_FALSE) {
		...
		struct cvi_isp_ee_tun_4_cfg *cfg_4 = &(sharpen_cfg->ee_4_cfg);
		...
		cfg_4->REG_1E8.bits.MF_COEF_0 = (CVI_S8) -1;
		cfg_4->REG_1E8.bits.MF_COEF_1 = (CVI_S8) -4;
		cfg_4->REG_1EC.bits.MF_COEF_2 = (CVI_S8) -7;
		cfg_4->REG_1EC.bits.MF_COEF_3 = (CVI_S8) -8;
		cfg_4->REG_1F0.bits.MF_COEF_4 = (CVI_S8) -12;
		cfg_4->REG_1F0.bits.MF_COEF_5 = (CVI_S8) -12;
		cfg_4->REG_1F4.bits.MF_COEF_6 = (CVI_S8) -8;
		cfg_4->REG_1F4.bits.MF_COEF_7 = (CVI_S8) 15;
		cfg_4->REG_1F8.bits.MF_COEF_8 = (CVI_S8) 40;
		cfg_4->REG_1F8.bits.MF_COEF_9 = (CVI_S8) 80;
	}
