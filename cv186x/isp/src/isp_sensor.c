...
CVI_S32 isp_snsSync_info_set(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *syncCfg, CVI_U32 be_frm_idx)
{
	...
	snr_update.snr_cfg_node.snsr.magic_num = be_frm_idx + 5 - pstIspCtx->stAeResult.u8MeterFramePeriod;
	snr_update.snr_cfg_node.snsr.magic_num_vblank = be_frm_idx + 5
							- pstIspCtx->stAeResult.u8MeterFramePeriod;
