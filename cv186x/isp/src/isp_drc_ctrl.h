...
enum drc_debug_mode {
	DRC_DBG_LMAP_MODE = 25,
	DRC_DBG_SMOOTH_WIN = 26,
	DRC_DBG_REFINEWEIGHT_THRESH = 27,
	DRC_DBG_RGBGAMMA_BYPASS = 28,
	DRC_DBG_SHOW_LMAP = 29,
	DRC_DBG_DUMP_CURVE = 30,//1:global 2:dark 3:bright
	DRC_DBG_DISABLE_LTM = 31//1:disable dark 2:disable bright
};
