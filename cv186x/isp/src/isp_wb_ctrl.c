...
static CVI_S32 isp_wb_ctrl_postprocess(VI_PIPE ViPipe)
{
	...
	switch (ViPipe) {
	case 0:
		inst_base = ISP_WBG_ID_FE0_LE;
		pre_fe_num = 2;
		post_num = 2;
	break;
	case 1:
		inst_base = ISP_WBG_ID_FE1_LE;
		pre_fe_num = 2;
		post_num = 2;
	break;
	case 2:
		inst_base = ISP_WBG_ID_FE2_LE;
		pre_fe_num = 2;
		post_num = 2;
	break;
	case 3:
		inst_base = ISP_WBG_ID_FE3_LE;
		pre_fe_num = 2;
		post_num = 2;
	break;
	case 4:
		inst_base = ISP_WBG_ID_FE4_LE;
		pre_fe_num = 2;
		post_num = 2;
	break;
	case 5:
		inst_base = ISP_WBG_ID_FE5_LE;
		pre_fe_num = 2;
		post_num = 2;
	break;
	default:
...
#else
	inst_base = ISP_WBG_ID_RAW_TOP_LE;
	post_num = 2;
#endif
