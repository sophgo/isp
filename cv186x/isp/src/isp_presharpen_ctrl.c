...
static CVI_S32 isp_presharpen_ctrl_preprocess(VI_PIPE ViPipe, ISP_ALGO_RESULT_S *algoResult)
{
	...
	if (presharpen_attr->enOpType == OP_TYPE_MANUAL) {
		...
		MANUAL(presharpen_attr, MFCoreGain);
		MANUAL(presharpen_attr, GlobalGain);
		MANUAL(presharpen_attr, ShootMode);
		...
		MANUAL(presharpen_attr, EnhanceMode);
		MANUAL(presharpen_attr, DarkLumaThr);
		MANUAL(presharpen_attr, BrightLumaThr);
		MANUAL(presharpen_attr, DarkEdgeThr);
		MANUAL(presharpen_attr, DarkEdgeStrength);
		MANUAL(presharpen_attr, BrightEdgeThr);
		MANUAL(presharpen_attr, BrightEdgeStrength);
		MANUAL(presharpen_attr, LineThr);
		MANUAL(presharpen_attr, LineStrength);
		...
		AUTO(presharpen_attr, MFCoreGain, INTPLT_POST_ISO);
		AUTO(presharpen_attr, GlobalGain, INTPLT_POST_ISO);
		AUTO(presharpen_attr, ShootMode, INTPLT_POST_ISO);
		...
		AUTO(presharpen_attr, EnhanceMode, INTPLT_POST_ISO);
		AUTO(presharpen_attr, DarkLumaThr, INTPLT_POST_ISO);
		AUTO(presharpen_attr, BrightLumaThr, INTPLT_POST_ISO);
		AUTO(presharpen_attr, DarkEdgeThr, INTPLT_POST_ISO);
		AUTO(presharpen_attr, DarkEdgeStrength, INTPLT_POST_ISO);
		AUTO(presharpen_attr, BrightEdgeThr, INTPLT_POST_ISO);
		AUTO(presharpen_attr, BrightEdgeStrength, INTPLT_POST_ISO);
		AUTO(presharpen_attr, LineThr, INTPLT_POST_ISO);
		AUTO(presharpen_attr, LineStrength, INTPLT_POST_ISO);
...
static CVI_S32 isp_presharpen_ctrl_postprocess(VI_PIPE ViPipe)
{
	...
	if (is_postprocess_update == CVI_FALSE) {
		...
		presharpen_cfg->mf_core_gain = runtime->presharpen_attr.MFCoreGain;
		...
		struct cvi_isp_preyee_tun_1_cfg *cfg_1 = &(presharpen_cfg->pre_ee_1_cfg);
		...
		struct cvi_isp_preyee_tun_2_cfg *cfg_2 = &(presharpen_cfg->pre_ee_2_cfg);
		...
		struct cvi_isp_preyee_tun_3_cfg *cfg_3 = &(presharpen_cfg->pre_ee_3_cfg);
		...
		struct cvi_isp_preyee_tun_4_cfg *cfg_4 = &(presharpen_cfg->pre_ee_4_cfg);

		cfg_4->REG_1DC.bits.HF_COEF_0   = (CVI_S8) 0;
		cfg_4->REG_1DC.bits.HF_COEF_1   = (CVI_S8) -4;
		cfg_4->REG_1E0.bits.HF_COEF_2   = (CVI_S8) -20;
		cfg_4->REG_1E0.bits.HF_COEF_3   = (CVI_S8) -36;
		cfg_4->REG_1E4.bits.HF_COEF_4   = (CVI_S8) 9;
		cfg_4->REG_1E4.bits.HF_COEF_5   = (CVI_S8) 220;
		cfg_4->REG_1E8.bits.MF_COEF_0   = (CVI_S8) -16;
		cfg_4->REG_1E8.bits.MF_COEF_1_0 = (CVI_S8) -32;
		cfg_4->REG_1E8.bits.MF_COEF_1_1 = (CVI_S8) -32;
		cfg_4->REG_1EC.bits.MF_COEF_2_0 = (CVI_S8) -32;
		cfg_4->REG_1EC.bits.MF_COEF_2_1 = (CVI_S8) -32;
		cfg_4->REG_1EC.bits.MF_COEF_3   = (CVI_S8) 0;
		cfg_4->REG_1F0.bits.MF_COEF_4_0 = (CVI_S8) 64;
		cfg_4->REG_1F0.bits.MF_COEF_4_1 = (CVI_S8) 64;
		cfg_4->REG_1F0.bits.MF_COEF_5   = (CVI_S8) 192;

		struct cvi_isp_preyee_tun_5_cfg *cfg_5 = &(presharpen_cfg->pre_ee_5_cfg);

		cfg_5->REG_200.bits.EE_DARK_LUMA_THR = runtime->presharpen_attr.DarkLumaThr;
		cfg_5->REG_204.bits.EE_BRIGHT_LUMA_THR = runtime->presharpen_attr.BrightLumaThr;
		cfg_5->REG_208.bits.EE_DARK_EDGE_THR = runtime->presharpen_attr.DarkEdgeThr;
		cfg_5->REG_20C.bits.EE_DARK_EDGE_STRENGTH = runtime->presharpen_attr.DarkEdgeStrength;
		cfg_5->REG_210.bits.EE_BRIGHT_EDGE_THR = runtime->presharpen_attr.BrightEdgeThr;
		cfg_5->REG_214.bits.EE_BRIGHT_EDGE_STRENGTH = runtime->presharpen_attr.BrightEdgeStrength;
		cfg_5->REG_218.bits.EE_LINE_THR =runtime->presharpen_attr.LineThr;
		cfg_5->REG_21C.bits.EE_LINE_STRENGTH = runtime->presharpen_attr.LineStrength;
		cfg_5->REG_220.bits.EE_TEXTURE_MODE = runtime->presharpen_attr.EnhanceMode;
		cfg_5->REG_220.bits.EE_SHOOT_MODE = runtime->presharpen_attr.ShootMode;
	}
