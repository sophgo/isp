...
#define ISP_IOCTL_V4L2_ERR(fd, v4l2_ec) \
	ISP_LOG_ERR("V4L2 IOCTL error, pipe = %d fd = %d value = %d ptr = %p id = %x err = %s\n", \
		ViPipe, fd, v4l2_ec.controls->value, v4l2_ec.controls->ptr, v4l2_ec.controls->id, strerror(errno))
#endif
