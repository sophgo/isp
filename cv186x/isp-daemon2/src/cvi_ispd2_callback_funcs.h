...
CVI_S32 CVI_ISPD2_CBFunc_ISP_GetTNRMotionAdaptAttr(TJSONRpcContentIn *ptIn,
	TJSONRpcContentOut *ptOut, JSONObject *pJsonRes);
CVI_S32 CVI_ISPD2_CBFunc_ISP_SetTNRMATFAttr(TJSONRpcContentIn *ptIn,
	TJSONRpcContentOut *ptOut, JSONObject *pJsonRes);
CVI_S32 CVI_ISPD2_CBFunc_ISP_GetTNRMATFAttr(TJSONRpcContentIn *ptIn,
	TJSONRpcContentOut *ptOut, JSONObject *pJsonRes);
...
CVI_S32 CVI_ISPD2_CBFunc_ISP_GetStatisticsConfig(TJSONRpcContentIn *ptIn,
	TJSONRpcContentOut *ptOut, JSONObject *pJsonRes);
CVI_S32 CVI_ISPD2_CBFunc_ISP_SetRgbirAttr(TJSONRpcContentIn *ptIn,
	TJSONRpcContentOut *ptOut, JSONObject *pJsonRes);
CVI_S32 CVI_ISPD2_CBFunc_ISP_GetRgbirAttr(TJSONRpcContentIn *ptIn,
	TJSONRpcContentOut *ptOut, JSONObject *pJsonRes);
