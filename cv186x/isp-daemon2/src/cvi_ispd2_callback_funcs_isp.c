...
// -----------------------------------------------------------------------------
CVI_S32 CVI_ISPD2_CBFunc_ISP_SetTNRMATFAttr(TJSONRpcContentIn *ptContentIn,
	TJSONRpcContentOut *ptContentOut, JSONObject *pJsonResponse)
{
	CVI_ISP_SET_API_EX(TNRMATF, ISP_TNR_MATF_ATTR_S);
}

// -----------------------------------------------------------------------------
CVI_S32 CVI_ISPD2_CBFunc_ISP_GetTNRMATFAttr(TJSONRpcContentIn *ptContentIn,
	TJSONRpcContentOut *ptContentOut, JSONObject *pJsonResponse)
{
	CVI_ISP_GET_API_EX(TNRMATF, ISP_TNR_MATF_ATTR_S);
}
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
CVI_S32 CVI_ISPD2_CBFunc_ISP_SetRgbirAttr(TJSONRpcContentIn *ptContentIn,
	TJSONRpcContentOut *ptContentOut, JSONObject *pJsonResponse)
{
	CVI_ISP_SET_API_EX(Rgbir, ISP_RGBIR_ATTR_S);
}

CVI_S32 CVI_ISPD2_CBFunc_ISP_GetRgbirAttr(TJSONRpcContentIn *ptContentIn,
	TJSONRpcContentOut *ptContentOut, JSONObject *pJsonResponse)
{
	CVI_ISP_GET_API_EX(Rgbir, ISP_RGBIR_ATTR_S);
}
...
// -----------------------------------------------------------------------------
CVI_S32 CVI_ISPD2_CBFunc_TEAISP_DRC_SetAttr(TJSONRpcContentIn *ptContentIn,
	TJSONRpcContentOut *ptContentOut, JSONObject *pJsonResponse)
{
	CVI_ISP_SET_API(CVI_TEAISP_DRC_SetAttr, CVI_TEAISP_DRC_GetAttr, TEAISP_DRC_ATTR_S);
}

CVI_S32 CVI_ISPD2_CBFunc_TEAISP_DRC_GetAttr(TJSONRpcContentIn *ptContentIn,
	TJSONRpcContentOut *ptContentOut, JSONObject *pJsonResponse)
{
	CVI_ISP_GET_API(CVI_TEAISP_DRC_GetAttr, TEAISP_DRC_ATTR_S);
}
