...
void CVI_ISPD2_ConfigMessageHandler(TISPD2HandlerInfo *ptHandlerInfo)
{
	...
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_SetTNRMATFAttr, "CVI_ISP_SetTNRMATFAttr");
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_GetTNRMATFAttr, "CVI_ISP_GetTNRMATFAttr");
	...
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_SetRgbirAttr, "CVI_ISP_SetRgbirAttr");
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_GetRgbirAttr, "CVI_ISP_GetRgbirAttr");
	...
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_TEAISP_DRC_SetAttr, "CVI_TEAISP_DRC_SetAttr");
	CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_TEAISP_DRC_GetAttr, "CVI_TEAISP_DRC_GetAttr");
