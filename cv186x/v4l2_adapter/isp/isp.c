...
void *get_sensor_obj(int pipe)
{
	...
	case V4L2_SMS_SC020HGS_MIPI_400P_120FPS_10BIT:
		pstSnsObj = &stSnsSC020HGS_Obj;
		break;
#endif
	...
	case V4L2_SMS_SC233HGS_MIPI_2M_60FPS_10BIT:
	case V4L2_SMS_SC233HGS_MIPI_2M_60FPS_10BIT_WDR2TO1:
		pstSnsObj = &stSnsSC233HGS_Obj;
		break;
#endif
	...
	case V4L2_SONY_IMX415_MIPI_2M_60FPS_12BIT:
	...
	case V4L2_SONY_IMX415_MIPI_8M_30FPS_10BIT:
